using Interrapidisimo_test.Core.ContributorAggregate.Events;
using Interrapidisimo_test.Core.ProjectAggregate.Specifications;
using Interrapidisimo_test.SharedKernel.Interfaces;
using MediatR;

namespace Interrapidisimo_test.Core.ProjectAggregate.Handlers;
